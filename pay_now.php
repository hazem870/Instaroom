...
if (isset($_POST['pay_now'])) {
    ...
    $query1 = "INSERT INTO booking_order(user_id, room_id, check_in, check_out, order_id, booking_status, trans_id, trans_amt, trans_status, trans_resp_msg) VALUES (?,?,?,?,?, 'booked', ?, ?, 'TXN_SUCCESS', 'Payment successful')";

    insert($query1, [
        $CUST_ID, $_SESSION['room']['id'], $frm_data['checkin'],
        $frm_data['checkout'], $ORDER_ID, 'TEST123456', $TXN_AMOUNT
    ], 'issssss');
